...
class SaleController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['sele_categories']=Category::all();
        $data['pay_types']=pay_type::all();
    ...
    public function show($id)
    {
        ...
        $data['pay_types']=pay_type::all();
       $data['sele_categories']=Category::all();
       $data['prodacts']=Prodact::where('categories_id',$id)->orderBy('id','asc')->get();

       return view('backend.sales.show',$data);
