   ...
   <div class="page-title-wrapper">
       <div class="page-title-heading">
           <div class="page-title-icon">
               <i class="pe-7s-employees icon-gradient bg-mean-fruit">
               </i>
           </div>
           <div>employees 
       ...
       <div class="page-title-actions">
           ...
           <a href=" {{ route('app.employees.create')}} " class=" btn btn-primary btn-sm ">
   ...
   <div class="col-md-12">
      ...
      <tr>
        ...
        <td class=" text-center">
         ...
         <td class="text-center ">
             <a class="btn btn-sm btn-info" href="{{ route('app.employees.show',$user->id) }}">  <i class=" fas fa-eye "> </i> <span>Show</span></a> 
             <a class="btn btn-sm btn-info" href="{{ route('app.employees.edit',$user->id) }}">  <i class=" fas fa-edit "> </i> <span>Edit</span></a>
             ...
             <form  id="delete-form-{{$user->id}}" method="POST" action="{{ route('app.employees.destroy',$user->id) }}" style=" display:none;">
                   @csrf
                   @method('DELETE')
